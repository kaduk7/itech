...
function Add({ reload }: { reload: Function }) {
    ...
    return (
        <>
            {/* <button onClick={handleShow2} type="button" className="btn btn-success btn-icon-text">
                Tambah</button> */}
            <Button label="Tambah" onClick={handleShow2} icon="mdi mdi-plus" severity="danger" />
            <Modal
                ...
                <form onSubmit={handleSubmit}>
                    <Modal.Header closeButton>
                        <Modal.Title style={{ fontFamily: "monospace", fontSize: 30, color: "black" }}>Kasir</Modal.Title>
                    </Modal.Header>
                    <Modal.Body>
                        <div className="row">
